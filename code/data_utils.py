...
def load_cifar(dataset_root, val_size = 5000, download = False):
    transform = transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.4914, 0.4822, 0.4465), (0.247, 0.243, 0.261))])
    cifar10_train = torchvision.datasets.CIFAR10(root=dataset_root, train=True, transform=transform, download = download)
    cifar10_test = torchvision.datasets.CIFAR10(root=dataset_root, train=False, transform=transform, download = download)
